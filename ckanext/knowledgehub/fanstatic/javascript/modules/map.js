ckan.module('knowledgehub-map', function($) {
    'use strict';
    ...
    return {
        initialize: function() {
            ...
            this.sandbox.subscribe('knowledgehub:updateMaps', this.onPropertyChange.bind(this));
        },
        resetMap: function() {
...
//                      -----------------------------------------------------------------
        ...
        teardown: function() {
            ...
            this.sandbox.unsubscribe('knowledgehub:updateMaps', this.onPropertyChange.bind(this));
        },
    }
});